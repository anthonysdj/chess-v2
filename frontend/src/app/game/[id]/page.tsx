...
export default function GamePage() {
  ...
  if (gameEnded) {
    const reasonText = gameEnded.reason === 'opponent_disconnected'
        ...
        <Card className="text-center">
          <div className="mb-6">
            <div className={`inline-flex items-center justify-center w-16 h-16 rounded-full mb-4 ${
              userWon ? 'bg-green-100 dark:bg-green-900/30' : 'bg-gray-100 dark:bg-gray-700'
            }`}>
              {userWon ? (
            ...
            <h2 className={`text-2xl font-bold mb-2 ${
              userWon ? 'text-green-600 dark:text-green-400' : 'text-gray-900 dark:text-white'
            }`}>
